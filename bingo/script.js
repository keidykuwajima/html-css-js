...
function sortear(){
    ...
    console.log(numeros_sorteados.length);
    if(numeros_sorteados.length == maximo){
        alert('Já sorteou todos os numeros!');
        return;
    }
    ...
    //adicionando um item no array "numeros sorteados"
...
function novo_jogo(){
    var confirmou = confirm("Tem certeza que quer um novo jogo?");
    if(confirmou == true){
