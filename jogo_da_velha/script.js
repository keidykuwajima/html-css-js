...
function verifica_ganhador(){
   ...
   // condições de vitória do jogador nas colunas
    ...
    if(linha1coluna2 == "O" && linha2coluna2 == "O" && linha3coluna3 == "O"){
        pontos_jogador++;
        mostrar_placar();
        retorno = true;
    }
    ...
    if(linha3coluna1 == "O" && linha2coluna2 == "O" && linha1coluna3 == "O"){
     ...
     // condições de vitória do CPU nas linhas
    ...
    // condições de vitória do CPU nas colunas
    ...
    if(linha1coluna3 == "X" && linha2coluna3 == "X" && linha1coluna3 == "X"){
        pontos_cpu++;
        mostrar_placar();
        retorno = true;
    }

    // condições de vitória do CPU nas diagonais
...
function numero_aleatorio(minimo, maximo){
    var numero_aleatorio = Math.floor(Math.random() * (maximo - minimo +1)) + minimo;
